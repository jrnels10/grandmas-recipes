...
module.exports = {
    ...
    getMyRecipe: async (req, res, next) => {
        ...
        Object.assign(recipe, { chefName: chefFound.chefName, ingredients, groups, recipeDescription, recipeImage, cookingInstructions, recipeName, dateSubmitted, _id, chefId: chefFound._id });
