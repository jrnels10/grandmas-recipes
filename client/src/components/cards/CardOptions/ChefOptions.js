...
class RecipeOptions extends Component {
    ...
    render() {
        ...
        return <motion.div
            initial={false}
            animate={{ backgroundColor: options ? "#fcf8f3" : "#698474" }}
            className={`options`}>

            {options ?
                <svg className="bi bi-x options-x-icon" onClick={this.toggleOptions} width="1em" height="1em" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className="bi bi-three-dots-vertical options-three-dot-icon" onClick={this.toggleOptions} width="1em" height="1em" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
