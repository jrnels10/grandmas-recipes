                ...
                <div className={`options-delay-${options}`}>
                    {options ?
                        <div className={`container-fluid options-diplay`}>
                            <NavigateButton customClassName='dashboard-button' pathTo={'/updateRecipe'} type={'editRecipe'} value={value} selected={recipe}>
                                Edit
                            ...
                            <NavigateButton customClassName='dashboard-button' pathTo={'/fullscreen'} type={'fullscreenRecipe'} value={value} selected={{ image }}>
