...
export default class FamilyIcon extends React.Component {

    render() {
        return (
            <svg className="icon-family" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
